    ...
    public partial class FrmFaturalar : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if(TxtFaturaID.Text != "" && CmbTur.Text=="Firma")
            {
                ...
                MessageBox.Show("Fatura Detay Sisteme Eklendi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                temizle();
            }
        ...
        private void simpleButton3_Click(object sender, EventArgs e)  //FrmFaturalar silme bölümü.
        {
            ...
            bgl.baglanti().Close();
            listele();
            MessageBox.Show("Fatura Bilgisi Silindi", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Error);
            temizle();
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            listele();
            MessageBox.Show("Fatura Bilgisi Güncellendi", "Güncel", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            temizle();
