    ...
    public partial class FrmFaturaUrunDuzenleme : Form
    {
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
           SqlCommand cmd = new SqlCommand("Update TBL_FATURADETAY set URUNAD=@P1,MIKTAR=@P2,FIYAT=@P3,TUTAR=@P4 where FATURAURUNID=@P5", bgl.baglanti());
            ...
            cmd.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Ürün Düzenlendi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Warning); 
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Ürün Detay Silindi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Error);
